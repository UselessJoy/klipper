...
class PrinterFanBack:
    ...
    def __init__(self, config):
        ...
        self.register_event_handler("temperature_host:sample_temperature", self._on_host_temp)
        self.register_event_handler("temperature_mcu:sample_temperature", self._on_mcu_temp)
